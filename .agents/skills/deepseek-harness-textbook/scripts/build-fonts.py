...
for pattern in ("第*次-*/*.md", "assets/lesson-*/**/*.scene.json", "assets/library/*.json", "assets/library/index.html", "site/*.html", "production/lesson-01/lesson-01-source-facts.md", ".agents/skills/deepseek-harness-textbook/scripts/*.cjs"):
