...
**[在线阅读](https://jonestark12138.github.io/deepseek-harness-source-learning/) · [直接读第一讲](https://jonestark12138.github.io/deepseek-harness-source-learning/previews/lesson-01.html) · [离线阅读包](https://github.com/jonestark12138/deepseek-harness-source-learning/releases/tag/lesson-01-v1.0.1)**

目前已完成第一讲，后续课程持续建设中。本项目为个人学习教材，与 DeepSeek 官方无隶属或背书关系。

## 这是阅读版

提供正文、课件、练习与答案、分享稿、术语词典、源码事实矩阵和六张成品插图。不提供独立物件素材、可编辑矢量、场景配方或教材制作工程。
